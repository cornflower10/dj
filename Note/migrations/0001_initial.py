# Generated by Django 2.1.5 on 2019-04-02 15:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createTime', models.DateTimeField(default=django.utils.timezone.now, verbose_name='创建日期')),
                ('updateTime', models.DateTimeField(auto_now=True, verbose_name='修改日期')),
                ('food', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Note.Food', verbose_name='食物')),
            ],
        ),
        migrations.CreateModel(
            name='MerchantInfo',
            fields=[
                ...
                ('createTime', models.DateTimeField(default=django.utils.timezone.now, verbose_name='创建日期')),
                ('updateTime', models.DateTimeField(auto_now=True, verbose_name='修改日期')),
                ('end_vip_time', models.DateTimeField(auto_now=True, verbose_name='vip到期日')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createTime', models.DateTimeField(default=django.utils.timezone.now, verbose_name='创建日期')),
                ('updateTime', models.DateTimeField(auto_now=True, verbose_name='修改日期')),
                ('end_vip_time', models.DateTimeField(blank=True, null=True, verbose_name='vip到期日')),
                ('business_flag', models.CharField(max_length=1, verbose_name='1营业中，2暂停营业')),
                ('image_url', models.CharField(max_length=100)),
                ('desc', models.CharField(max_length=100)),
                ('location', models.CharField(max_length=50)),
        ...
        migrations.AddField(
            model_name='images',
            name='merchant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Note.MerchantInfo', verbose_name='商户'),
        ),
        migrations.AddField(
            model_name='images',
            name='userinfo',
